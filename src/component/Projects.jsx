...
const Projects = () => {
  ...
  return (
    <div id="my-projects" className="">
      ...
      <h1 className="w-10/12 mx-auto text-4xl font-extrabold mb-4">1. Edu Quest</h1>
      <div className="relative mx-auto w-10/12 h-[500px] rounded-lg shadow-lg overflow-hidden group mb-20">
        ...
        <h1 className="text-4xl font-bold mb-2 text-green-500">Edu Quest</h1>
          <p className="text-sm">
           You can checkout different types of games. Can see the review of others and option for add review.
            ...
            <button className="flex items-center px-4 py-2 bg-purple-600 text-white rounded-md shadow hover:bg-purple-700 transition-all">
              <a
                href="https://edu-quest-aa2b3.web.app/"
                target="_blank"
      ...
      <h1 className="w-10/12 mx-auto text-4xl font-extrabold mb-4">2. Chill Gamer</h1>
      <div className="relative mx-auto w-10/12 h-[500px] rounded-lg shadow-lg overflow-hidden group mb-20">
        ...
        <h1 className="text-4xl font-bold mb-2">Chill Gamer</h1>
          <p className="text-sm">
           You can checkout different types of games. Can see the review of others and option for add review.
          </p>
        </div>
      ...
      <h1 className="w-10/12 mx-auto text-4xl font-extrabold mb-4">3. Volunteer Port</h1>
